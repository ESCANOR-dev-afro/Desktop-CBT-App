...
export default function QuestionBankTab({
  ...
  const rawAvailable = safeSubjectsByClass[currentClass] 
    || safeSubjectsByClass[currentClass?.replace?.(/\s+(Science|Art|Commercial|Gold|Silver|Diamond)$/i, '')] 
    || [];
  const rawList = Array.isArray(rawAvailable) ? rawAvailable : [];
    ...
    new Set(
      rawList
        ...
        .filter((name) => {
          ...
          if (currentClass && (currentClass.includes('Art') || currentClass.includes('Commercial'))) {
